  ...
  it('applyDragEnd returns null for drops it does not handle', () => {
    ...
    expect(
      applyDragEnd([], {
        active: {
          id: 'palette-upper',
          data: { current: { source: 'palette', plugin: { id: 'upper', name: 'Upper' } } },
        },
